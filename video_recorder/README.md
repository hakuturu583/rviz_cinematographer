...
The recorder is a composable ROS 2 node (`video_recorder::VideoRecorder`).
It is started automatically by the *rviz_cinematographer_gui* plugin within the same process.
...
or
```
$ ros2 run video_recorder video_recorder_node
```
...
2. **Topic** : /rviz/record  
   **Type** : rviz_cinematographer_msgs/msg/Record  
...
3. **Topic** : /rviz/finished_rendering_trajectory    
   **Type** : rviz_cinematographer_msgs/msg/Finished    
...
2. **Topic** : /video_recorder/wait_duration  
   **Type** : rviz_cinematographer_msgs/msg/Wait  
