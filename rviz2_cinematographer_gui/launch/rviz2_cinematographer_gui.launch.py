...
def generate_launch_description():
    share_dir = get_package_share_directory('rviz2_cinematographer_gui')
    default_rviz_config = os.path.join(share_dir, 'launch', 'rviz2_cinematographer_gui.rviz')
    ...
    gui = Node(
        ...
        output='screen',
        arguments=[
            '-s', 'rviz2_cinematographer_gui/RvizCinematographerGUI',
            '--args',
